...
def main(cfg : DictConfig) -> None:
    ...
    config_file_separated, pca_first_datalist_file, topfolder_source, topfolder_target, topfolder_target_debug = paths
    ...
    for di in range(len(structure_df)):   
        ...
        try: 
            ...
            source_aligned = rotate(source, matr, mode = "bilinear", extra = rot90).astype(np.int16)
            if dochecks:
    ...
    structure_df.to_csv(pca_first_datalist_file)
